...
class PCA9685: #pour commander les sorties pwm
    def __init__(self, bus, address_PCA9685=0x60):
        ...
        self.freqPWM_Hz = 250 # Frequence des PWM
...
class brushless:
    ...
    def __init__(self, PCA9685, num_moteur):
        ...
        self.valeur_repos = 1500 # valeur milieu de la commande => pour laquelle la vitesse est nulle
...
marques_servo = { "FUTABA S3107":   {"valeur_repos_us": 1.5*10**3, "angle_min": -50, "angle_max": 70, "decalage_us_max": 1.286},
...
class servo:
    # PCA9685    : instance de la classe PCA9685 utilisee
    # num_moteur : numero de la PWM de la PCA9685
    def __init__(self, PCA9685, num_moteur, nom_modele):
        self.num_moteur = num_moteur
        self.myPCA9685 = PCA9685
        #valeur milieu de la commande => pour laquelle la vitesse est nulle
        self.valeur_repos_us = marques_servo[nom_modele]["valeur_repos_us"]
        self.angle_min = marques_servo[nom_modele]["angle_min"]
        self.angle_max = marques_servo[nom_modele]["angle_max"]
        self.decalage_us_max = marques_servo[nom_modele]["decalage_us_max"]
