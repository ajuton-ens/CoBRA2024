...
class PCA9685: #pour commander les sorties pwm
    ...
    def reset(self): # software reset
        ...
        #self.bus.write_byte_data(self.address_PCA9685,0x0,0b00000110)
...
class brushless:
    ...
    def cmd_vit_pourcent(self, vitesse_pourcent):
        ...
        if 0 < vitesse_pourcent and vitesse_pourcent < 9:
            vitesse_pourcent = self.seuil_vitesse_pos_pourcent+vitesse_pourcent*(9-self.seuil_vitesse_pos_pourcent)/9
        if 0 > vitesse_pourcent and vitesse_pourcent > -9:
            vitesse_pourcent = self.seuil_vitesse_neg_pourcent+vitesse_pourcent*(9+self.seuil_vitesse_neg_pourcent)/9
