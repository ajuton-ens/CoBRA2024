...
import smbus2  
import cobra_pca9685_v05 as cobra_pca9685

myi2cbus = smbus2.SMBus(1) # Initialisation du bus I2C
myPCA9685 = cobra_pca9685.PCA9685(myi2cbus) # Initialisation du générateur de PWM

numeros_moteurs = {"brushless": [0, 1, 2, 3, 4], "MCC": [[5, 6], [7, 8]]}

mot = []
for i in range(0,4): # Initialisation des moteurs
    mot.append(cobra_pca9685.brushless(myPCA9685,i)) 
