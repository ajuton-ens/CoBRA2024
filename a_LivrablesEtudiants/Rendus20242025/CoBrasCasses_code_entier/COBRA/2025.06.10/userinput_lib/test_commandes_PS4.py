...
def timeloop(stdscr):
    while True:
        ...
        if fy>=0:
            cine_vol.liste_forces_couples[cine_vol.FY_INDEX] = min(1,fy+PS4_cmd_values["fy"]/40)
        else:
            cine_vol.liste_forces_couples[cine_vol.FY_INDEX] = max(-1,fy+PS4_cmd_values["fy"]/40)
...
class MyController(Controller):
    ...
    def on_L3_left(self,value):
        cine_vol.liste_forces_couples[cine_vol.CY_INDEX] = value/32767
        cine_vol.cmd_mot_avec_forces(cine_vol.liste_forces_couples)
        TUI.refresh_TUI(self.stdscr)
    ...
    def on_L3_up(self,value):
        value = +value/32767
        cine_vol.liste_forces_couples[cine_vol.FZ_INDEX] = value#/32767
        cine_vol.cmd_mot_avec_forces(cine_vol.liste_forces_couples)
        TUI.refresh_TUI(self.stdscr)
    ...
    def on_R3_left(self,value):
        cine_vol.liste_forces_couples[cine_vol.CZ_INDEX] = value/32767
        cine_vol.cmd_mot_avec_forces(cine_vol.liste_forces_couples)
        TUI.refresh_TUI(self.stdscr)
    ...
    def on_R3_up(self,value):
        cine_vol.liste_forces_couples[cine_vol.FX_INDEX] = value/32767
        cine_vol.cmd_mot_avec_forces(cine_vol.liste_forces_couples)
        TUI.refresh_TUI(self.stdscr)
