...
import smbus2
import time
import MyBNO055 as MyBNO055
import MyTFLuna as MyTFLuna
import MyTag  as MyTag# Assure-toi que la classe Tag est bien définie dedans
...
class Fusion:
    ...
    def step(self, mode=False, mode2=False):
        ...
        return self.current_measure.flatten()
