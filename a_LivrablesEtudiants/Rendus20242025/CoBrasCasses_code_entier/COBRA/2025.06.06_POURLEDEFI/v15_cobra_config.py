...
brushless_g_config = { "propulsion":   {"valeur_repos_us": 1.52*10**3, "seuil_vitesse_neg_pourcent": -10, "seuil_vitesse_pos_pourcent": 10, "sens": 1, "coeff_multiplicatif":1}
            }

brushless_d_config = { "propulsion":   {"valeur_repos_us": 1.52*10**3, "seuil_vitesse_neg_pourcent": -10, "seuil_vitesse_pos_pourcent": 10,"sens": 1, "coeff_multiplicatif":1}
            }

MCC2_config = { "lent":   {"seuil_vitesse_neg_pourcent": -4.5, "seuil_vitesse_pos_pourcent": 4.5},
               "pince":   {"seuil_vitesse_neg_pourcent": -4.5, "seuil_vitesse_pos_pourcent": 4.5}
            }
...
servo_config = { "cerceau":   {"valeur_repos_us": 1.5*10**3, "angle_min": -70, "angle_max": 90, "decalage_us_max": 1.286},
                 "axe":   {"valeur_repos_us": 1.5*10**3, "angle_min": -70, "angle_max": 90, "decalage_us_max": 1.286}
            }
