...
global hedge
hedge = MarvelmindHedge(tty="COM3", recieveLinearDataCallback=updateUSNavData, recieveAccelerometerDataCallback = updateAccData, debug=False)  # create MarvelmindHedge thread recieveAccelerometerDataCallback=updateAccData
