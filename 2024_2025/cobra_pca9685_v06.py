...
class servo:
    ...
    def __init__(self, PCA9685, num_moteur, nom_modele):
        ...
        self.valeur_repos_us = marques[nom_modele]["valeur_repos_us"]
        self.angle_min = marques[nom_modele]["angle_min"]
        self.angle_max = marques[nom_modele]["angle_max"]
        self.decalage_us_max = marques[nom_modele]["decalage_us_max"]
