...
import smbus2
import cobra_pca9685_v06

myi2cbus = smbus2.SMBus(1) # Initialisation du bus I2C
myPCA9685 = cobra_pca9685_v06.PCA9685(myi2cbus) # Initialisation du générateur de PWM
...
servo["cerceau"]= cobra_pca9685_v06.servo(myPCA9685,4, "FUTABA S3107")
servo["axe"]= cobra_pca9685_v06.servo(myPCA9685,5, "HITEC HS-475HB")
brushless["gauche"] = cobra_pca9685_v06.brushless(myPCA9685,6)
brushless["droite"] = cobra_pca9685_v06.brushless(myPCA9685,7)
